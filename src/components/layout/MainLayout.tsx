...
const MainLayout: React.FC = () => {
  ...
  // Single auth listener that updates user + admin state immediately on sign-in
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (user) => {
      ...
      // Optimistically set admin false and then check role (Firestore/custom claims)
      setIsAdmin(false)
      try {
        ...
        setIsAdmin(false)
        // console.error('isCurrentUserAdmin failed', err)
      } finally {
        setCheckingAuth(false)
      }
    })
            ...
            <div className="flex items-center space-x-4">
              {!checkingAuth && !currentUser ? (
                <>
                  ...
                  <Link to="/signup" className="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary/90">Sign Up</Link>
                </>
              ) : currentUser ? (
                <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Connecting passionate founders with resources, co-founders, and investors to build the next generation of startups.</p>
            </div>

            <div>
              <h3 className="text-lg font-semibold mb-4">For Founders</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Find Co-Founders</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Startup Resources</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Fundraising</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Browse Startups</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">AI Recommendations</a></li>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© {new Date().getFullYear()} StartHub. All rights reserved.</p>
